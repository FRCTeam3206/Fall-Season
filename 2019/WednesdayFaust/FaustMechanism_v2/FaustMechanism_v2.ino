...
#define AUX_PIN           1  //aux channel
#define RIGHT_PWM_0_PIN   9  // confirmed pin  9 is pwm output
#define RIGHT_MOTOR_PIN   12  // confirmed pin 10 is pwm output 
#define AUX_MOTOR_PIN    10  // confirmed pin 11 is pwm output
...
#define K_THROTTLE            0.10    // speed multiplier to decrease steering sensitivity.  0.65 gives about a 4" turn radius at max throttle
#define K_STEERING            0.10    // speed multiplier to decrease steering sensitivity.  0.65 gives about a 4" turn radius at max throttle


int pos = 0;    //for servo position
 ...
 */
  ...
  if ((900 < throttle)&& (throttle < 2100) && (900 < steering) && (steering < 2100)){
    ...
    if (aux > 1500) {
      ...
      auxMotor.write(pos);              // tell servo to go to position in variable 'pos'
