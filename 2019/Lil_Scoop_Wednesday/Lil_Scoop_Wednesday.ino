...
#define RIGHT_PWM_0_PIN   12  // confirmed pin  9 is pwm output
...
#define K_THROTTLE            0.03    // speed multiplier to decrease steering sensitivity.  0.65 gives about a 4" turn radius at max throttle
#define K_STEERING            0.01    // speed multiplier to decrease steering sensitivity.  0.65 gives about a 4" turn radius at max throttle
