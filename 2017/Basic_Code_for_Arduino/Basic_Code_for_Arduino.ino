...
void turnRight (double speed) {       // speed should be a value less than 1500
  myservoStarboard.writeMicroseconds(speed);
  myservoPort.writeMicroseconds(speed);
  desiredSpeed = speed;
}

void turnLeft (double speed) {       // speed should be a value greater than 1500
  myservoStarboard.writeMicroseconds(speed);
  myservoPort.writeMicroseconds(speed);
  desiredSpeed = speed;
}
